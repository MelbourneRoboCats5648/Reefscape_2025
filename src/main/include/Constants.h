...
namespace DriveConstants {
  ...
  inline constexpr units::angle::turn_t kFrontRightMagOffset = -0.2099609375_tr; // CAN ID 10
...
namespace ElevatorAndArmConstants {
  static constexpr ElevatorArmGoal kDefaultGoal = {ElevatorConstants::kFirstStageDefaultHeight + ElevatorConstants::kMaxSecondStageHeight, ArmConstants::retractSoftLimit};
